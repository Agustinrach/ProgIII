...
{
	[Serializable]
	public class Rectangulo: NodeElement, IControllable, ILabelElement
	{
		...
		public Rectangulo(): this(0, 0, 100, 100)
		{}

		public Rectangulo(Rectangle rec): this(rec.Location, rec.Size)
		{}

		public Rectangulo(Point l, Size s): this(l.X, l.Y, s.Width, s.Height) 
		{}

		public Rectangulo(int top, int left, int width, int height): base(top, left, width, height)
		{
