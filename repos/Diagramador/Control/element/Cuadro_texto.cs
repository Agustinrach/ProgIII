...
{
	[Serializable]
	public class Cuadro_texto: RectangleElement, IControllable, ILabelElement
	{
		[NonSerialized]
		...
		public Cuadro_texto(): this(0, 0, 100, 100)
		{}

		public Cuadro_texto(Rectangle rec): this(rec.Location, rec.Size)
		{}

		public Cuadro_texto(Point l, Size s): this(l.X, l.Y, s.Width, s.Height) 
		{}

		public Cuadro_texto(int top, int left, int width, int height): base(top, left, width, height)
		{
