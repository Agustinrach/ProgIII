...
namespace Dalssoft.DiagramNet
{
	...
	{
		protected Cuadro_texto_nodo connector1;
		protected Cuadro_texto_nodo connector2;
		protected LineCap startCap;
		protected LineCap endCap;
		protected bool needCalcLink = true;

		internal BaseLinkElement(Cuadro_texto_nodo conn1, Cuadro_texto_nodo conn2): base()
		{
			borderWidth = 1;
		...
		[Browsable(false)]
		public Cuadro_texto_nodo Connector1
		{
			get
			{
				return connector1;
		...
		[Browsable(false)]
		public Cuadro_texto_nodo Connector2
		{
			get
			{
				return connector2;
