...
{
	[Serializable]
	public class Circulo: RectangleElement, IControllable
	{
		[NonSerialized]
		...
		public Circulo(Rectangle rec): base(rec) {}

		public Circulo(Point l, Size s): base(l, s) {}

		public Circulo(int top, int left, int width, int height): base(top, left, width, height) {}
