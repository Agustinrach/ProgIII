...
{
	[Serializable]
	public class Circulo_con_nodo: NodeElement, IControllable, ILabelElement
	{
		protected Circulo elipse;
		protected LabelElement label = new LabelElement();

		[NonSerialized]
		private ElipseController controller;

		public Circulo_con_nodo(): this(0, 0, 100, 100)
		{}

		public Circulo_con_nodo(Rectangle rec): this(rec.Location, rec.Size)
		{}

		public Circulo_con_nodo(Point l, Size s): this(l.X, l.Y, s.Width, s.Height) 
		{}

		public Circulo_con_nodo(int top, int left, int width, int height): base(top, left, width, height)
		{
			elipse = new Circulo(top, left, width, height);
			SyncContructors();
		}
