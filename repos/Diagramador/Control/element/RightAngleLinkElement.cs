...
namespace Dalssoft.DiagramNet
{
	...
	public class RightAngleLinkElement: BaseLinkElement, IControllable, ILabelElement
	{
		...
		public RightAngleLinkElement(Cuadro_texto_nodo conn1, Cuadro_texto_nodo conn2): base(conn1, conn2)
		{
			needCalcLink = true;
		...
		private void InitConnectors(Cuadro_texto_nodo conn1, Cuadro_texto_nodo conn2)
		{
